        ...
        this.save = async () => {
            ...
            if (this.state.existing) {
                ...
                if (this.state.password)
                    configs.apiKey = (0, js_md5_1.default)(`${configs.username}:${this.state.password}`);
            }
            else {
                configs = {
                    type: 1 /* Fever */,
                    ...
                    fetchLimit: this.state.fetchLimit,
                    apiKey: (0, js_md5_1.default)(`${this.state.username}:${this.state.password}`),
                };
